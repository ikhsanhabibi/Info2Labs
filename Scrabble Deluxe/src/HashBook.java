...
public class HashBook {
	...
	/**
	 * genartaes a STring of random 7 letters
	 * @return a random string of length 7
	 */
	private String randon7letters(){
		String out = "";
		for (int i=0;i<7;i++){
			int number = random.nextInt(26);//26 because the alphabet has 26 characcters
			char letter = (char) (number + 65);// plus 65 because that is the asci representation of A
